...
public partial class VerticalTimetableRow
{
	...
	// 	get
	// 	{
	// 		// If we have a state object, read from it
	// 		if (RowState is not null)
	// 		{
	// 			return (LocationStates)RowState.LocationState;
	// 		}
	...
	// 				if (RowState is not null)
	// 				{
	// 					VerticalPageStateFactory.UpdateRowLocationState(RowState, 0, IsLastRow);
	// 				}
	...
	// 			if (RowState is not null)
	// 			{
	// 				VerticalPageStateFactory.UpdateRowLocationState(RowState, (int)value, IsLastRow);
	// 			}
	// 			else
	// 			{
	...
	/// <summary>
	/// The underlying state model for this row (from factory)
	/// </summary>
	public VerticalTimetableRowState? RowState { get; set; } = null;
