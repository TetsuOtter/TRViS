...
public class VerticalTimetableRowNew
{
	...
	public VerticalTimetableRowNew(Grid parentGrid, VerticalTimetableRowModel model, VerticalTimetableColumnVisibilityState visibilityState, DTACMarkerViewModel markerViewModel, bool isLastRow)
	{
