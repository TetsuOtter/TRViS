...
public class OriginalTimetableV1Tests : BaseUITest
{
	...
	/// <summary>
	/// After committing a Work selection (cascades to ActiveTrain),
	...
	public void V1Page_AfterTrainSelected_ShowsHeaderWithTrainNumber()
	{
		...
		// Commit first work WITHOUT going to DTAC so we stay on StartHome.
		// StartHome→V1 navigation works reliably; DTAC→V1 hits a MAUI Android
		// push-route blank-page bug (two consecutive Routing.RegisterRoute routes).
