...
/// <summary>
/// Adapter that wraps the framework-agnostic <see cref="LocationService"/> so the
/// DTAC presenter sees an <see cref="IDtacLocationServiceController"/>.
/// </summary>
public sealed class WebLocationServiceAdapter : IDtacLocationServiceController
{
	private readonly LocationService _locationService;

	public WebLocationServiceAdapter(LocationService locationService)
	{
